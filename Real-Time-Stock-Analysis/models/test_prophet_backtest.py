...
def run_prophet_backtest(
    ...
    """
    Run an expanding-window Prophet backtest.
    ...
    while (
        ...
        try:
            ...
            # --------------------------------------------------
            # Fit Prophet using ONLY historical training data
            # --------------------------------------------------
    ...
    if len(actuals) == 0:
        ...
        raise RuntimeError(
            "No successful Prophet forecasts were generated."
        )
...
def main():
    ...
    print("=" * 60)
    print("PROPHET EXPANDING-WINDOW BACKTEST")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("1-DAY PROPHET BACKTEST")
    print("=" * 60)

    metrics_1, actual_1, predicted_1 = run_prophet_backtest(
        data=data,
        target_column="Close",
        horizon=1,
    ...
    print("\n" + "=" * 60)
    print("3-DAY PROPHET BACKTEST")
    print("=" * 60)

    metrics_3, actual_3, predicted_3 = run_prophet_backtest(
        data=data,
        target_column="Close",
        horizon=3,
        initial_train_size=initial_train_size,
    ...
    print("\n" + "=" * 60)
    print("10-DAY PROPHET BACKTEST")
    print("=" * 60)

    metrics_10, actual_10, predicted_10 = run_prophet_backtest(
        data=data,
        target_column="Close",
        horizon=10,
        initial_train_size=initial_train_size,
    ...
    print("\n" + "=" * 60)
    print("15-DAY PROPHET BACKTEST")
    print("=" * 60)

    metrics_15, actual_15, predicted_15 = run_prophet_backtest(
        data=data,
        target_column="Close",
        horizon=15,
        initial_train_size=initial_train_size,
    ...
    print("\n")
    print("=" * 60)
    print("PROPHET BACKTEST SUMMARY")
    print("=" * 60)
