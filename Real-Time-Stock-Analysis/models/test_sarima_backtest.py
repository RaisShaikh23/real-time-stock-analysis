...
def run_sarima_backtest(
    ...
    """
    Run an expanding-window SARIMA backtest.
    ...
    order : tuple
        SARIMA non-seasonal (p, d, q) configuration.

    seasonal_order : tuple
        SARIMA seasonal (P, D, Q, m) configuration.
    ...
    while (
        ...
        try:
            ...
            # --------------------------------------------------
            # Fit SARIMA using ONLY historical training data
            # --------------------------------------------------
    ...
    if len(actuals) == 0:
        ...
        raise RuntimeError(
            "No successful SARIMA forecasts were generated."
        )
...
def main():
    ...
    print("=" * 60)
    print("SARIMA EXPANDING-WINDOW BACKTEST")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("1-DAY SARIMA BACKTEST")
    print("=" * 60)

    metrics_1, actual_1, predicted_1 = run_sarima_backtest(
        data=data,
        target_column="Close",
        order=order,
        seasonal_order=seasonal_order,
    ...
    print("\n" + "=" * 60)
    print("3-DAY SARIMA BACKTEST")
    print("=" * 60)

    metrics_3, actual_3, predicted_3 = run_sarima_backtest(
        data=data,
        target_column="Close",
        order=order,
        seasonal_order=seasonal_order,
    ...
    print("\n" + "=" * 60)
    print("10-DAY SARIMA BACKTEST")
    print("=" * 60)

    metrics_10, actual_10, predicted_10 = run_sarima_backtest(
        data=data,
        target_column="Close",
        order=order,
        seasonal_order=seasonal_order,
    ...
    print("\n" + "=" * 60)
    print("15-DAY SARIMA BACKTEST")
    print("=" * 60)

    metrics_15, actual_15, predicted_15 = run_sarima_backtest(
        data=data,
        target_column="Close",
        order=order,
        seasonal_order=seasonal_order,
    ...
    print("\n" + "=" * 60)
    print("SARIMA BACKTEST COMPLETE")
    print("=" * 60)
